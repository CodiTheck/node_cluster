...
shader_type canvas_item; render_mode blend_mul;
// Attributes.
uniform vec4 tint: hint_color = vec4 (0.0, 0.0, 1.0, 1.0); uniform sampler2D noise_texture2: hint_black;
uniform sampler2D gradient_texture: hint_black; uniform vec2 scroll_direction1 = vec2 (0.7, -0.7);
uniform float time_scale1: hint_range (0.001, 0.25) = 0.012;
uniform float tile_factor1: hint_range (0.1, 3.0) = 0.6; uniform vec2 scroll_direction2 = vec2 (0.75, 0.25);
